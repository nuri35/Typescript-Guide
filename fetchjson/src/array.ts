...
// carmakers3.push(100); // error number ekleyemem cunku carmakers3 ıcerısı string[] yanı strıng beklıyor onun ıcın number ekleyemem

// help with 'map'
const abcxss = carmakers3.map((car: string): string => {
...
// flexible types
const importantDates = [new Date(), 'saas', 'asas', 'x'];
